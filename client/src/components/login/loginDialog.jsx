                    ...
                    
                    {
                        account.view === 'login' ?
                            <Wrapper>
                                ...
                                <Text > By continuing, you agree to StyleSavvy's Terms of Use and Privacy Policy.</Text>
                                <LoginButton onClick={() => loginUser () }>Login</LoginButton>
                                <Typography style={{textAlign: 'center'}}>OR</Typography>
                                <RequestOTP style={{textAlign: 'center'}}>Request OTP</RequestOTP>
                                <CreateAccount onClick={() => toggleSignup()}>New to StyleSavvy? Create an account</CreateAccount>
                            </Wrapper>
                        :
                            <Wrapper>
